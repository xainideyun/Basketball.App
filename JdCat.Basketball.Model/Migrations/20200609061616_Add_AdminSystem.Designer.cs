...
namespace JdCat.Basketball.Model.Migrations
{
    ...
    [Migration("20200609061616_Add_AdminSystem")]
    partial class Add_AdminSystem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JdCat.Basketball.Model.Domain.AccessAuthority", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JdCat.Basketball.Model.Domain.NLogInfo", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JdCat.Basketball.Model.Domain.Role", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JdCat.Basketball.Model.Domain.RoleUser", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JdCat.Basketball.Model.Domain.User", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("JdCat.Basketball.Model.Domain.AccessAuthority", b =>
                {
                    b.HasOne("JdCat.Basketball.Model.Domain.Role", "Role")
                        .WithMany("Routes")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("JdCat.Basketball.Model.Domain.User", "User")
