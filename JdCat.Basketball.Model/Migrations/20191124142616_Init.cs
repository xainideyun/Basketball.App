        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GetLost = table.Column<int>(nullable: false),
                    Status = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasMyselfProgram = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "UserInfo",
                columns: new[] { "ID", "City", "Country", "CreateTime", "FaceUrl", "Gender", "HasMyselfProgram", "Name", "NickName", "OpenId", "Phone", "PlayNumber", "Province" },
                values: new object[] { 1, "武汉", "中国", new DateTime(2019, 9, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 1, false, "对手1", "对手1", null, "13900000000", "1", "湖北" });
